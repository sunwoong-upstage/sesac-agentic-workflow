...
이 스크립트는 에이전트의 주요 기능을 시연합니다:
1. Plan-and-Solve 기법을 활용한 여행 계획
2. 3가지 도구 호출 (RAG, 예산 추정, 웹 검색)
3. 이중 메모리 시스템 시연 (단기 + 장기)
...
def main():
    ...
    print_section("실행 완료")
    print("\n이 데모는 다음을 시연했습니다:")
    print("  1. Plan-and-Solve 기법: 계획 수립 -> 정보 수집 -> 응답 종합")
    print("  2. 단기 메모리 (MemorySaver): 같은 thread_id로 대화 맥락 유지")
    print("  3. 장기 메모리 (USER_PROFILES): 사용자 선호도 누적")
    print("  4. 도구 호출: RAG 검색, 예산 추정, 웹 검색\n")
